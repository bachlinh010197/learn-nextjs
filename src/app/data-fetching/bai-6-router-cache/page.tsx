    ...
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <div className="mb-4 overflow-x-auto rounded-xl bg-zinc-900 p-6 text-sm text-zinc-100">
          <pre>
            <code>{`User điều hướng (client-side navigation)
│
...
└── Cache bị xoá khi:
    ...
    └── Hard navigation (full page reload)`}</code>
          </pre>
        </div>
      </section>
...
export async function updateProduct() {
  ...
  // → Invalidate cả Data Cache, Full Route Cache VÀ Router Cache
      ...
      <section className="mb-10">
        ...
        <pre className="mb-4 overflow-x-auto rounded-xl bg-zinc-900 p-4 text-sm text-zinc-100">
          <code>{`// Kịch bản: User điều hướng giữa các trang sản phẩm
//
...
// app/products/[id]/page.tsx ← Cached riêng cho mỗi id`}</code>
        </pre>
      </section>
