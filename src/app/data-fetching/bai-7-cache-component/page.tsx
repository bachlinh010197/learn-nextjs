  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <div className="mt-4 overflow-x-auto rounded-xl bg-zinc-900 p-6 text-sm text-zinc-100">
          <pre>
            <code>{`// So sánh:
//
...
// database chỉ được query 1 lần duy nhất!`}</code>
        </pre>
      </section>
...
// → Nếu muốn cache giữa các request, dùng unstable_cache hoặc Data Cache`}</code>
        </pre>
      </section>
